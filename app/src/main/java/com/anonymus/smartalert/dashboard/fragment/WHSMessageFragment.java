...
public class WHSMessageFragment extends Fragment implements View.OnClickListener {

    private Button mButtonMessage;
    private Button mButtonRepeat;
    private TextView mTextMenu;

    public WHSMessageFragment() {
        // Required empty public constructor
    }

    public static WHSMessageFragment newInstance() {
        Bundle args = new Bundle();
        WHSMessageFragment fragment = new WHSMessageFragment();
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.button_message : {
                MainBus.getInstance().getBus().post(new EventChangeFragmentBackStack(MessageFrgment.newInstance()));
                break;
            }
